...
public class MainActivity extends Activity {
    ...
    private void updateStatus() {
        boolean enabled = ShizukuHelper.isServiceEnabled(this);
        if (enabled) {
            tvStatus.setText("服务已开启 | " + (isWeChatInstalled() ? "微信已安装" : "微信未安装"));
